...
public class InvoiceResponse {
    ...
    @Schema(name = "invoiceId", description = "Unique Id of invoice on database")
    private long invoiceId;
    @Schema(name = "customer", description = "Unique Id of customer that represents the owner of invoice")
